-- Breathship Database Schema
-- Execute this in your Supabase SQL editor to set up all tables
...
CREATE INDEX IF NOT EXISTS idx_sessions_active ON sessions(is_active, date);
CREATE INDEX IF NOT EXISTS idx_testimonials_active ON testimonials(is_active, is_featured);
...
INSERT INTO blogs (title, excerpt, content, image_link, is_published) VALUES
...
INSERT INTO sessions (title, date, time, tag, description, payment_link, image_link, is_active) VALUES
('Introduction to Breathwork', '2024-02-15', '10:00:00', 'Group', 'Perfect for beginners! Learn the fundamentals of conscious breathing and discover how it can transform your life.', 'https://example.com/pay/intro', 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&h=600&fit=crop', true),
('Deep Healing Session', '2024-02-20', '14:00:00', 'One-on-One', 'A personalized session focused on deep emotional healing through advanced breathwork techniques.', 'https://example.com/pay/healing', 'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=800&h=600&fit=crop', true),
('Corporate Wellness Workshop', '2024-02-25', '09:00:00', 'Corporate', 'Transform your workplace culture with stress-reducing breathwork techniques designed for busy professionals.', 'https://example.com/pay/corporate', 'https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=800&h=600&fit=crop', true);

-- Insert default testimonials
INSERT INTO testimonials (name, text, image_link, is_active, is_featured) VALUES
('Sarah Johnson', 'Breathwork has completely transformed my approach to stress management. I feel more centered and peaceful than ever before.', 'https://images.unsplash.com/photo-1494790108755-2616b612b786?w=150&h=150&fit=crop&crop=face', true, true),
('Michael Chen', 'After just three sessions, I noticed a significant improvement in my sleep quality and overall mood. Highly recommend!', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop&crop=face', true, true),
('Emma Rodriguez', 'The corporate workshop was exactly what our team needed. We''re all feeling more focused and less stressed at work.', 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=150&h=150&fit=crop&crop=face', true, false),
('David Thompson', 'I was skeptical at first, but the results speak for themselves. My anxiety has decreased dramatically since starting breathwork.', 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop&crop=face', true, false),
('Lisa Park', 'The one-on-one sessions helped me work through some deep emotional blocks. I feel lighter and more free than ever.', 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=150&h=150&fit=crop&crop=face', true, false);
...
CREATE POLICY "Admin full access for content" ON content FOR ALL USING (auth.role() = 'authenticated');
CREATE POLICY "Admin full access for blogs" ON blogs FOR ALL USING (auth.role() = 'authenticated');
CREATE POLICY "Admin full access for sessions" ON sessions FOR ALL USING (auth.role() = 'authenticated');
